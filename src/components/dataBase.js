...
export const massageList = [
  {
    ...
    linkTitle: "Namour massage Deep tissue massage",
    shortDescription:
      "Deep tissue massage therapy is with deeper strokes or harder pressure. Deep tissue massages use firm pressure and slow stroked to massage deep layers of muscle and fascia, which is the connective tissue that surrounds your muscles.",
    description: {
      paragraph1:
        "Deep tissue massage therapy is with deeper strokes or harder pressure. Deep tissue massages use firm pressure and slow stroked to massage deep layers of muscle and fascia, which is the connective tissue that surrounds your muscles.",
      paragraph2:
...

  {
    ...
    linkTitle: "Namour massage Swedish massage",
    shortDescription:
    ...
    description: {
      paragraph1:
        "Swedish massage therapy is the most well-known and widely practiced type of therapeutic massage—and for good reason. This type of massage focuses on muscle relaxation, targeting superficial muscles (rather than the connective tissues targeted in deep-tissue massage) and increasing blood circulation.",
      paragraph2:
        "Wondering if you should request a reservation for a Swedish massage? Explore some of the benefits below to learn why a Swedish massage might be a great choice for you.",
      paragraph3: "",
      paragraph4: "",
      ...
      list: {
        ...
        listParagraph4:
          "Increased circulation and decreased stress can lead to a general boost of energy. ",
        listHeader5: "Improve Posture",
        listParagraph5:
          "While postural imbalances have many sources, including overworked muscles due to repetitive strain, overcompensating muscles to ease stress on overworked muscles, prolonged sitting, or injury, Swedish Massage helps to ease the muscular holding that underlies postural imbalance.",
        listHeader6: "Increase Blood Flow",
        listParagraph6:
          "Massage therapy can dilate the blood vessels and widens the membrane pores, improving your body’s ability to deliver fresh blood to muscles and organs. Endorphin Release to Improve Mood Research shows increased serotonin and dopamine in massage recipients, improving their mood and feeling of emotional well-being.",
        listHeader7: "Support Healthy Immunity",
        listParagraph7:
          "When it comes to overall health, it is important to take a holistic approach. Increased physical pain can also increase mental stress and an increase in stress from environmental factors can manifest in the muscles. In addition, any stress can lead to an immune deficiency. Because Swedish Massage encourages relaxation and a decrease in body tension, it supports a healthy immune system.",
        listHeader8: "Improve Sleep",
        listParagraph8:
          "Studies show that getting a massage increases serotonin levels in the body, so you can fall asleep faster and stay asleep longer.",
...

  {
    ...
    linkTitle: "Namour massage Ashiatsu barefoot massage",
    shortDescription:
      "Ashiatsu barefoot massage is performed on a standard massage table that additionally has ceiling-mounted bars for the therapist holds on to for balance and control during the treatment. Oil or lotion is used to enhance the client’s experience.",
    description: {
      paragraph1:
        "Ashiatsu barefoot massage is performed on a standard massage table that additionally has ceiling-mounted bars for the therapist holds on to for balance and control during the treatment. Oil or lotion is used to enhance the client’s experience.",
      paragraph2:
      ...
      header2: "The benefits of massage",
      paragraph5:
        "Ashiatsu massage has a number of advantages over the more traditional types, here are just a few of them:",
      list: {
        ...
        listParagraphInner2:
          "Moreover, old injuries and the associated scar tissues and adhesions also respond well to this type of therapy. Ashiatsu massage, on the other hand, can deliver up to three times more pressure than any of these, but without the associated soreness. In fact, Ashiatsu massage actually feels overall much gentler than other kinds, but with the enhanced benefit of going much deeper.",
        listParagraphInner3:
...

  {
    ...
    linkTitle: "Namour massage Thai massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage Hot stone massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage prenatal massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage Four hand massage",
    shortDescription:
    ...
    description: {
      ...
      list: {
        listHeader1: "",
        listParagraph1:
          "By two massage therapists instead of just one, Four Hand massage provides even more relaxation than the standard method. By working different areas of the body at the same time, Four Hands massage allows for more intense muscle-soothing than a regular massage.",
        listHeader2: "",
        listParagraph2:
...

  {
    ...
    linkTitle: "Namour massage Couples massage",
    shortDescription:
    ...
    description: {
      ...
      header2: "The benefits of massage",
      paragraph5:
        "Some clients can be intimidated by a traditional, solo massage session. In a couples massage, clients experience a massage with someone they know, which can provide a level of comfort and security. Each individual still gets a custom massage to reach their personal goals and receives unique treatments that are specific to them.",
      list: {
        listHeader1: "",
        listParagraph1:
          "A couples massage can be perfect way to celebrate a special occasion, a birthday, an anniversary, or just because.  You can also get massage with a good friend or family member. Best friends can let all their stresses slip away, and parent and child can relax together in a safe and calm environment.",
        listHeader2: "",
        listParagraph2: "",
        listParagraphInner1: "",
        listParagraphInner2: "",
...

  {
    ...
    linkTitle: "Namour massage Cupping massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage Wood therapy massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage Honey massage",
    shortDescription:
      "Honey massage is one of the massage types originating in ancient Tibet. Honey is used in this massage as a sticky substance that can pull out the “polluted” energy from the body and, by infiltrating the skin, supply the organism with its fantastic healing properties",
    description: {
      paragraph1:
      ...
      list: {
        listHeader1: "",
        listParagraph1:
          "Honey massage considerably improves blood circulation in deeper layers of the skin and warms and tones it. It also promoting improvements in nutrition and waste removal in the skin and in all of internal organs and help to eliminates the pain.",
        listHeader2: "",
        listParagraph2: "",
        listParagraphInner1: "",
        listParagraphInner2: "",
...

  {
    ...
    alt: "Body scrub",
    linkName: "BodyScrub",
    linkTitle: "Namour massage Body scrub",
    shortDescription:
      "A full body scrub massage is a type of exfoliation treatment that uses a Body Scrub to remove dead skin cells and promote circulation. Body scrubs are usually made with natural ingredients such as sugar, salt, coffee, or oats. can also be infused with essential oils for an added therapeutic benefits.",
    description: {
      paragraph1:
        "A full body scrub massage is a type of exfoliation treatment that uses a Body Scrub to remove dead skin cells and promote circulation. Body scrubs are usually made with natural ingredients such as sugar, salt, coffee, or oats. can also be infused with essential oils for an added therapeutic benefits.",
      paragraph2: "",
...

  {
    ...
    linkTitle: "Namour massage Lymphatic drainage massage",
    shortDescription:
...

  {
    ...
    linkTitle: "Namour massage Lomi Lomi massage",
    shortDescription:
      "Lomi Lomi is a wonderful full body massage experience that leaves you feeling mellow and comforted inside and out. ",
    description: {
      paragraph1:
        "Lomi Lomi is a wonderful full body massage experience that leaves you feeling mellow and comforted inside and out. ",
      paragraph2:
